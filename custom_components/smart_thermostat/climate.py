...
from homeassistant.components.climate import PLATFORM_SCHEMA, ClimateDevice, ClimateEntity
from homeassistant.components.climate.const import (
    ...
    PRESET_AWAY, SUPPORT_PRESET_MODE, SUPPORT_TARGET_TEMPERATURE,PRESET_COMFORT)
...
class SmartThermostat(ClimateEntity, RestoreEntity):
    ...
    def preset_modes(self):
        ...
        #if self._away_temp:
        return [PRESET_AWAY,PRESET_COMFORT]
        #return None
    ...
    async def async_set_preset_mode(self, preset_mode: str):
        ...
        if preset_mode == PRESET_AWAY and not self._is_away:
            ...
            await self._async_control_heating(force=True)
        elif preset_mode == PRESET_COMFORT and self._is_away:
            self._is_away = False
